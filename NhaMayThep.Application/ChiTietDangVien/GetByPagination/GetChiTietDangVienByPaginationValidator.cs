...
{
    public class GetChiTietDangVienByPaginationValidator : AbstractValidator<GetChiTietDangVienByPaginationQuery>
    {
        public GetChiTietDangVienByPaginationValidator()
        {
            Configure();
        }
