...
namespace NhaMayThep.Application.LuongSanPham.Create
{
    public class CreateLuongSanPhamCommandHandler : IRequestHandler<CreateLuongSanPhamCommand, string>
    {
        ...
        //private IMucSanPhamRepository _mucSanPham;
        private readonly ICurrentUserService _currentUserService;
        public CreateLuongSanPhamCommandHandler(ILuongSanPhamRepository LuongSanPhamRepository, INhanVienRepository nhanVienRepository, /*IMucSanPhamRepository mucSanPham,*/ ICurrentUserService currentUserService)
        {
            _LuongSanPhamRepository = LuongSanPhamRepository;
            _nhanVienRepository = nhanVienRepository;
            //_mucSanPham = mucSanPham;
