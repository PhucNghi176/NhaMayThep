...
{
    public class GetThongTinGiamTruGiaCanhByPaginationValidator : AbstractValidator<GetThongTinGiamTruGiaCanhByPaginationQuery>
    {
        public GetThongTinGiamTruGiaCanhByPaginationValidator()
        {
            Configure();
        }
