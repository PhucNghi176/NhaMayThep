...
namespace NhaMayThep.Application.KhenThuong.UpdateKhenThuong
{
    public class UpdateKhenThuongCommandHandler : IRequestHandler<UpdateKhenThuongCommand, string>
    {
        ...
        public UpdateKhenThuongCommandHandler(IKhenThuongRepository repository, IMapper mapper, INhanVienRepository nhanvien, IChinhSachNhanSuRepository chinhsach, ICurrentUserService currentUserService)
        {
