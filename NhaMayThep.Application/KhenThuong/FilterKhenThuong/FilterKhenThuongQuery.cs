...
namespace NhaMayThep.Application.KhenThuong.FilterKhenThuong
{
    public class FilterKhenThuongQuery : IRequest<PagedResult<KhenThuongDTO>>, IQuery
    {
        ...
        public FilterKhenThuongQuery(int pageNumber, int pageSize, string maSoNhanVien, int chinhSachNhanSuID, string tenDotKhenThuong, DateTime ngayKhenThuong, decimal tongThuong)
        {
